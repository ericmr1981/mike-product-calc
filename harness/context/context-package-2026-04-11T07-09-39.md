# Context Package
> Built by ContextAssembler | 2026-04-11T07-09-39 | task: 看看这个项目
...
?? mike-product-calc/.harness-spawn-f-003.json
...
- **Task**: 继续 F-002
- **Mode**: keyword
- **Started**: 2026-04-11T07:09:39.077Z
- **Status**: running
- **Sprints**: f-002
...
### `harness/context/context-package-2026-04-11T06-51-17.md`
#### lines 1-22
```
# Context Package
> Built by ContextAssembler | 2026-04-11T06-51-17 | task: 看看这个项目
...
- **Task**: 完成 PRD 全部功能
- **Mode**: keyword
- **Started**: 2026-04-11T06:41:07.078Z
- **Status**: running
- **Sprints**: f-001
...
## Matrix Flags
- [SINGLE_STORY] dispatch only feature F

## ✂️  Relevant Snippets (extracted; large docs are NOT inlined)
> If more context is needed, request specific files/sections; do not ask for “the whole doc”.

### `harness/context/context-package-2026-04-11T06-41-05.md`
#### lines 1-22
```
# Context Package
> Built by ContextAssembler | 2026-04-11T06-41-05 | task: 看看这个项目
...
- **Task**: 看看这个项目
- **Mode**: keyword
- **Started**: 2026-04-11T06:39:49.227Z
- **Status**: running
- **Sprints**: f-001
...
### `harness/context/context-package-2026-04-11T06-39-48.md`
#### lines 1-22
```
# Context Package
> Built by ContextAssembler | 2026-04-11T06-39-48 | task: 看看这个项目

## 📋 Git State
```

### `harness/context/context-package-2026-04-11T06-51-19.md`
#### lines 1-22
```
# Context Package
> Built by ContextAssembler | 2026-04-11T06-51-19 | task: 看看这个项目
...
---
*ContextAssembler v1 | 2026-04-11T07-09-39*
# Context Package
> Built by ContextAssembler | 2026-04-11T06-22-27 | task: 继续 F-002
...
?? mike-product-calc/.harness-spawn-f-002.json
?? mike-product-calc/.harness-spawn-sprint-1.json
...
?? mike-product-calc/harness/oracles/
...
## 项目
.claude | /Users/ericmr/Documents/GitHub/.claude
...
- **Task**: 继续 F-002
- **Mode**: keyword
- **Started**: 2026-04-11T06:21:35.446Z
- **Status**: running
- **Sprints**: f-002

## Sprint Plan
- **f-002**: engineering-senior-developer | deps: none | attachments: standard
## Matrix Flags
- [SINGLE_STORY] dispatch only feature F-0
...
### `harness/context/context-package-2026-04-11T06-21-34.md`
#### lines 1-22
```
# Context Package
...
### `harness/reports/sprint-f-002-report.md`
#### lines 1-48
```
...
| Dispatch Time | 2026-04-11T06:21:35.447Z |
...
| Selected Feature | F-002 — SKU 毛利分析（双口径） |
...
## Master Brief
/Users/ericmr/Documents/GitHub/mike-product-calc/harness/assignments/master-brief-1775888495446.md

```

---
*ContextAssembler v1 | 2026-04-11T06-22-27*